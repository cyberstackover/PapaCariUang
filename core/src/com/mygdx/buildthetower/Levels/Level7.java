...
public class Level7 implements Screen {
    ...
    private static final String LEVEL = "7";
    ...
    public Level7(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,261,154,0);
        stars[1]=addStar(world,261,317,1);
        stars[2]=addStar(world,261,471,2);
        stars[3]=addStar(world,194,231,3);
        stars[4]=addStar(world,194,383,4);
    }
