...
public class Level5 implements Screen {
    ...
    public Level5(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,124,453,0);
        stars[1]=addStar(world,184,518,1);
        stars[2]=addStar(world,331,363,2);
        stars[3]=addStar(world,257,327,3);
        stars[4]=addStar(world,210,401,4);
    }
