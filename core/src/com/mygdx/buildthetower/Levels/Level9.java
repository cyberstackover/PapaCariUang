...
public class Level9 implements Screen {
    ...
    private static final String LEVEL = "9";
    ...
    public Level9(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,345,174,0);
        stars[1]=addStar(world,124,174,1);
        stars[2]=addStar(world,405,235,2);
        stars[3]=addStar(world,56,235,3);
        stars[4]=addStar(world,237,235,4);
    }
