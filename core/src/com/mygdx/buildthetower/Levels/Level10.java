...
public class Level10 implements Screen {
    ...
    public Level10(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,82,221,0);
        stars[1]=addStar(world,279,194,1);
        stars[2]=addStar(world,247,411,2);
        stars[3]=addStar(world,180,319,3);
        stars[4]=addStar(world,130,146,4);
    }
    ...
    private void makeCone() {
        ...
        if(!(dropLocation.x < 80 && dropLocation.y > 495)) {
