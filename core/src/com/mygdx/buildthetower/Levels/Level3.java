...
public class Level3 implements Screen {
    ...
    public Level3(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,270,500,0);
        stars[1]=addStar(world,180,200,1);
        stars[2]=addStar(world,280,340,2);
        stars[3]=addStar(world,110,100,3);
        stars[4]=addStar(world,265,100,4);
    }
