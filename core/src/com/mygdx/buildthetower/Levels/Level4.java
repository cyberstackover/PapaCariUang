...
public class Level4 implements Screen {
    ...
    public Level4(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,216,226,0);
        stars[1]=addStar(world,135,270,1);
        stars[2]=addStar(world,286,182,2);
        stars[3]=addStar(world,135,180,3);
        stars[4]=addStar(world,315,120,4);
    }
