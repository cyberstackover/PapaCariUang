...
public class Level2 implements Screen {
    ...
    public Level2(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,180,350,0);
        stars[1]=addStar(world,210,400,1);
        stars[2]=addStar(world,150,400,2);
        stars[3]=addStar(world,180,150,3);
        stars[4]=addStar(world,180,250,4);
    }
    ...
    private void setupCinder() {
        ...
        cinder.addListener(new InputListener()
        {
            ...
            public boolean touchDown(InputEvent event, float x, float y,
                ...
                cinder.addAction(Actions.alpha(.55f));
                startLocationX = stage.getViewport().unproject(new Vector2(Gdx.input.getX(),0f)).x;
                startLocationY = stage.getViewport().unproject(new Vector2(0f,Gdx.input.getY())).y;
                return true;
        ...
        crate.addListener(new InputListener()
        {
            ...
            public boolean touchDown(InputEvent event, float x, float y,
                ...
                if(state ==  State.play && !crate.hasActions()) {
                    ...
                    crate.addAction(Actions.alpha(.55f));
                    startLocationX = stage.getViewport().unproject(new Vector2(Gdx.input.getX(), 0f)).x;
                    startLocationY = stage.getViewport().unproject(new Vector2(0f, Gdx.input.getY())).y;
                    return true;
                }
