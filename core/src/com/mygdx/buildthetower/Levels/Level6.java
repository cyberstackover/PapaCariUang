...
public class Level6 implements Screen {
    ...
    private static final String LEVEL = "6";
    ...
    public Level6(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,340,310,0);
        stars[1]=addStar(world,184,381,1);
        stars[2]=addStar(world,90,657,2);
        stars[3]=addStar(world,150,200,3);
        stars[4]=addStar(world,280,340,4);
    }
