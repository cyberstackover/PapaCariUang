...
public class Level11 implements Screen {
    ...
    private static final String LEVEL = "11";
    ...
    public Level11(BuildTheTower app) {
        this.app = app;
    }
    ...
    private void setupStars() {
        stars[0]=addStar(world,243,217,0);
        stars[1]=addStar(world,196,111,1);
        stars[2]=addStar(world,293,111,2);
        stars[3]=addStar(world,274,164,3);
        stars[4]=addStar(world,218,164,4);
    }
